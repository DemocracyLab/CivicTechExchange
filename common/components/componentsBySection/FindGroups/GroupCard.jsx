...
class GroupCard extends React.PureComponent<Props> {
  ...
  _renderLogo(): React$Node {
    ...
    return (
      <div className="ProjectCard-logo">
        <img src={this.props.group && this.props.group.group_thumbnail ? this.props.group.group_thumbnail.publicUrl : "/static/images/projectlogo-default.png"}/>
      </div>
    )
  }
  ...
  _renderGroupDescription(): React$Node {
    return (
        <div className="ProjectCard-description">
          <p>{Truncate.stringT(this.props.group.group_short_description, this.props.maxTextLength)}</p>
        </div>
    );
  }
  ...
  _renderSubInfo(): React$Node {
    const group: GroupTileAPIData = this.props.group;
    const location: string = group.group_country && GroupAPIUtils.getLocationDisplayName(group.group_country);
    return (
