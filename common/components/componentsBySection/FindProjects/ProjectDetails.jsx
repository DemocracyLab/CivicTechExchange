      ...
      return(
          ...
          {this.state.projectUrl &&
              <div className="AboutProjects-icon-row">
                ...
                <p className="AboutProjects-url-text"><a href={urlHelper.appendHttpIfMissingProtocol(this.state.projectUrl)} target="_blank" rel="noopener noreferrer">{urlHelper.beautify(this.state.projectUrl)}</a></p>
              </div>
          }
