...
class InviteProjectToGroupModal extends React.PureComponent<Props, State> {
  ...
  askForSendConfirmation(): void {
    metrics.logGroupInviteProjectSubmit(this.state.selectedGroup.group_id, this.props.projectId);
  ...
  handleSubmit() {
    ...
    ProjectAPIUtils.post("/api/group/" + this.state.selectedGroup.group_id + "/invite",
      {
