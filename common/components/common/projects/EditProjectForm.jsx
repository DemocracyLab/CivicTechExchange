...
class EditProjectForm extends React.PureComponent<Props, State> {
  ...
  _renderError(): React$Node {
    return <div className="EditProjectForm-error">{this.state.error}</div>;
  }
      ...
      <div className="EditProjectForm-root create-form white-bg">
        ...
        <div className="form-group">
          ...
          <textarea
            ...
            onChange={this.onFormFieldChange.bind(
              this,
              "project_short_description"
            )}
          ></textarea>
        ...
        <div className="form-group">
          <label>
            ...
            {window.PROJECT_DESCRIPTION_EXAMPLE_URL ? (
              <a
                className="label-hint create-form-project-example"
                target="_blank"
          ...
          <textarea
            ...
            onChange={this.onFormFieldChange.bind(this, "project_description")}
          ></textarea>
          *Required
        </div>
        ...
        <div className="form-group">
          ...
          <textarea
            ...
            placeholder="Describe the actions that needed to be token..."
            rows="6"
            maxLength="1000"
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={this.onFormFieldChange.bind(this, "link_coderepo")}
          />
        </div>
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={this.onFormFieldChange.bind(this, "link_messaging")}
          />
        </div>
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={this.onFormFieldChange.bind(this, "link_projmanage")}
          />
        </div>
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={this.onFormFieldChange.bind(this, "link_filerepo")}
          />
        </div>
