  ...
  render(): React$Node {
    return (
      <div>
        <NotificationModal
          ...
          message={
            this.state.emailConfirmationError
              ? "Failed to send email, please contact admin@democracylab.org"
        ...
        <div>
          <p>
            You have not verified your email address yet. Check your email inbox
            and click on the supplied link. If you can't find the link, click{" "}
            <span
