  ...
  render(): React$Node {
    ...
    return (
      <div
        ...
        <div><label className="CollapsibleMenuItem"><input type="checkbox" className="ContextualCollapsible-selectAll" onChange={this._selectAll()}></input>Select All</label></div>
        {this.props.children}
      </div>
    );
  }
