    ...
    return (
      <React.Fragment>
        <input
          ...
          type="hidden"
          id={this.state.formIds[0]}
          name={this.state.formIds[0]}
        ...
        <div className="form-group">
          ...
          <div>
            <DatePicker
              ...
              onChange={date =>
                this.onChangeDateTime(date, this.state.dateTimeEnd)
              }
        ...
        <input
          ref={this.endDateRef}
          type="hidden"
          id={this.state.formIds[1]}
          name={this.state.formIds[1]}
        ...
        <div className="form-group">
          ...
          <div>
            <DatePicker
              ...
              onChange={date =>
                this.onChangeDateTime(this.state.dateTimeStart, date)
              }
