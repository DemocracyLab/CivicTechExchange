      ...
      <FileDrop
        ...
        className={
          this.props.hasImagePreview
            ? "FileSelectButton-wrapper FileSelectButton-imagePreview"
            : "FileSelectButton-wrapper"
        }
      >
        <div
          className="FileSelectButton-innerWrapper"
          style={previewImageStyle}
        >
          <div className="FileSelectionButton-dragTargetArea"></div>
          <div className="FileSelectButton-innerContent">
            <div className="FileSelectButton-dragFiles">
              {this.props.dragText || "Drag Your Files Here or"}
            </div>
            <div className="FileSelectButton-button">
              <input
                type="button"
                value={this.props.buttonText || "Browse Photos On Computer"}
