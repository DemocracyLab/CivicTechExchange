...
import type {
  HereGeocodeResponse,
  HereGeocodeResponseAddress,
  HereGeocodeResponseLocation,
} from "../../utils/hereApi.js";
...
export function getLocationInfoFromGeocodeResponse(
  geocodeResponse: HereGeocodeResponse
): ?LocationInfo {
  const geoCodeLocation: HereGeocodeResponseLocation = _.get(
    geocodeResponse,
...
export function getLocationInfoFromProject(
...
export function getLocationInfoFromGroup(
