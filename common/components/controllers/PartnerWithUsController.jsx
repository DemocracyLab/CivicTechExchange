  ...
  _renderEventSponsorshipSection(): React$Node {
    return (
      <div className="PartnerWithUsController-sponsorTypeSection col-xs-12 col-md-6">
        ...
        <p>
          DemocracyLab organizes hackathons every other month in partnership
          with other Seattle tech-for-good organizations. Sponsorships allow us
          to feed attendees breakfast and lunch, and pays for other incidental
          expenses.
        </p>
        <p>
          Sponsors are listed on all promotional materials, receive call-outs on
          social media, have time to introduce their company to the audience
          during the event, and an opportunity to staff a table at the events if
          desired.
        </p>
      </div>
    );
  ...
  _renderPlatformSponsorshipSection(): React$Node {
    return (
      <div className="PartnerWithUsController-sponsorTypeSection col-xs-12 col-md-6">
        ...
        <p>
          DemocracyLab's web platform now attracts nearly 1,000 users per month,
          most of whom are skilled technologists seeking opportunities to
          contribute their talents to projects that advance the public good.
        </p>
        <p>
          Your sponsorship allows us to cover overhead costs associated with
          running our platform and expenses related to marketing our work and
          growing our audience.
        </p>
        <p>
          Your company's linked logo will be included in the footer of all pages
          of our website, and a description of your company and its value
          proposition will be featured on our Sponsors page. DemocracyLab thanks
          our sponsors on social media at least monthly.
        </p>
      </div>
    );
  }
