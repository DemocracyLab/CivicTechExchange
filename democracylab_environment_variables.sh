...
export FOOTER_LINKS='[{"u":"https://connect.democracylab.org","n":"About"},{"u":"https://connect.democracylab.org/donatenow","n":"Donate"},{"u":"mailto:hello@democracylab.org","n":"Contact Us"}]'
