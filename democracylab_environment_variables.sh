...
# Sponsor information
export SPONSORS_METADATA='[{"displayName":"Amazon","url":"https://www.aboutamazon.com/our-communities/amazon-in-the-community","thumbnailUrl":"https://d1agxr2dqkgkuy.cloudfront.net/img/amazon_logo_transparent.png","description":"At Amazon, we focus on building long-term and innovative programs that will have a lasting, positive impact in communities around the world.","category":"Sustaining"},{"displayName":"Microsoft","url":"https://www.microsoft.com/en-us/","thumbnailUrl":"https://d1agxr2dqkgkuy.cloudfront.net/img/msft_logo_transparent.png","description":"We’re on a mission to empower every person and every organization on the planet to achieve more.","category":"Advancing"},{"displayName":"HERE Technologies","url":"https://www.here.com/","thumbnailUrl":"https://d1agxr2dqkgkuy.cloudfront.net/img/here_technologies.png","description":"By building a digital representation of reality entirely built upon location data, we are radically transforming the way the world lives, moves and interacts","category":"Advancing"}]'
