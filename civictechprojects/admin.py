...
class ProjectAdmin(admin.ModelAdmin):
    list_display = (
        tuple(project_text_fields) + ("project_creator",) + project_filter_fields
    )
...
class ProjectRelationshipAdmin(admin.ModelAdmin):
    ...
    search_fields = [
        "relationship_project__project_name",
        "relationship_group__group_name",
        "relationship_event__event_name",
        "introduction_text",
    ]
...
volunteer_relation_filter_fields = (
    "is_approved",
    "is_co_owner",
    "is_team_leader",
    "projected_end_date",
    ...
    "last_reminder_date",
    "reminder_count",
    "re_enrolled_last_date",
    "re_enroll_last_reminder_date",
    "re_enroll_reminder_count",
)
...
class ProjectFileAdmin(admin.ModelAdmin):
    ...
    search_fields = [
        "file_user__email",
        "file_project__project_name",
        "file_group__group_name",
        "file_event__event_name",
        "file_key",
    ]
    list_filter = (
        "file_category",
...
class EventProjectAdmin(admin.ModelAdmin):
    list_display = (
        event_project_filter_fields + ("creator",) + tuple(event_project_text_fields)
    )
    search_fields = event_project_text_fields + [
        "creator__email",
        "event__event_name",
