...
CSP_STYLE_SRC = ("'self'", "'unsafe-inline'", 'fonts.googleapis.com', 'heapanalytics.com/', '*.fontawesome.com')
...
CSP_CONNECT_SRC = ("'self'", S3_BUCKET_URL, '*.qiqochat.com', 'qiqocableeu.herokuapp.com', '*.google-analytics.com', '*.nr-data.net', 'heapanalytics.com/', '*.hereapi.com', '*.hotjar.com')
CSP_FONT_SRC = ("'self'", 'fonts.googleapis.com', 'heapanalytics.com/', 'fonts.gstatic.com', 'use.fontawesome.com')
