#!/bin/bash
# run ./bashrc-setup.sh to initialize your .bashrc file, and then set your secrets and custom parameters in it
if [[ -f .bashrc ]] ; then
    echo '.bashrc already exists. Changes need to be merged instead. Aborting'
    exit
fi
# This line will copy all the lines below it into the new file
awk 'NR==1,/COPY-LINES-BELOW-HERE/{next} 1' bashrc-setup.sh >.bashrc ; exit
#!/bin/bash
#
# If you add new ENV variables here, be sure to add a description and place holder exports to bashrc-setup.sh 
# DO NOT PUT SECRETS IN bashrc-setup.sh
#
...
#provided by heroku on DB creation
#export DL_DATABASE=postgres://vbsgwxrscejmqe:d103ab5c119dd6325aacbd9372f5099784f3aab2dc816a59f1b4c6fbfe49db52@ec2-34-200-35-222.compute-1.amazonaws.com:5432/d8vmuaklav0ovp

export DL_DATABASE="{'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': 'd8vmuaklav0ovp',
        'USER': 'vbsgwxrscejmqe',
        'PASSWORD': 'd103ab5c119dd6325aacbd9372f5099784f3aab2dc816a59f1b4c6fbfe49db52',
